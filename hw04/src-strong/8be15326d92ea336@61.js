...
<h3>從上圖中，我們可以看出：
  <ul>
    <li>工作地點在北部的占此問卷的多數(大於一半)</li>
    <li>整體而言藝術工作者對於「台灣 2050 淨零排放」政策的瞭解處於中間(3)的程度</li>
    <li>僅有非常少數的人對該政策瞭解程度很高(程度5)</li>
  </ul>
</h3>`
)}
...
d3
  .scaleOrdinal()
  .domain(["北部", "南部", "中部", "東部", "國外", "1","2","3","4","5"])
  //.range(d3.schemePaired)
  .range(["#FFBB3C","#DDE16B","#EE578A","#DA463D","#96AC0D","#47AC0D","#EABBFF","#AAD8DB","#DBFFBB","#FFC6BB"])
  .unknown("#BEBEBE")
)}
