...
function _simple1(d3,output_data,invalidation)
{
   // 指定圖表的尺寸。
  const width = 1000;
  const height = 1100;
...
function _dragFig(d3,output_data,drag,invalidation)
{
  // 指定圖表的尺寸。
  const width = 1000;
  const height = 1100;
...
function _personalImg(d3,output_data,drag,invalidation)
{
  // 指定圖表的尺寸。
  const width = 1000;
  const height = 1100;
...
export default function define(runtime, observer) {
  ...
  main.variable(observer("simple1")).define("simple1", ["d3","output_data","invalidation"], _simple1);
  main.variable(observer()).define(["md"], _4);
  main.variable(observer("dragFig")).define("dragFig", ["d3","output_data","drag","invalidation"], _dragFig);
  main.variable(observer()).define(["md"], _6);
  main.variable(observer("personalImg")).define("personalImg", ["d3","output_data","drag","invalidation"], _personalImg);
