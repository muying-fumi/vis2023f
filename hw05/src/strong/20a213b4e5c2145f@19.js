...
function _appleImg(d3,output_data,drag,url_list,invalidation)
{
  // 指定圖表的尺寸。
  const width = 2000;
  const height = 400;
...
FileAttachment("output_group@1.json").json()
)}
...
export default function define(runtime, observer) {
  ...
  const fileAttachments = new Map([
    ["output_group@1.json", {url: new URL("./files/2c022a5bea7d397fee23aac2f7c11e9f460788e72cbca41598632a02e5a018d0688c2a8b6724fe878fcb2ae61ad60f14a709a981378acd314f36c8c60ab19cbb.json", import.meta.url), mimeType: "application/json", toString}]
  ]);
  main.builtin("FileAttachment", runtime.fileAttachments(name => fileAttachments.get(name)));
  main.variable(observer()).define(["md"], _1);
  main.variable(observer("appleImg")).define("appleImg", ["d3","output_data","drag","url_list","invalidation"], _appleImg);
